...
<%		
		...
		try{
		    ...
		    if (rs.next()) {
				out.println("Username already being used! <a href='../add-user.jsp'>try again</a>");
		    }
			...
			if (rs.next()){
				out.println("Email already being used! <a href='../add-user.jsp'>try again</a>");
			}
			...
			out.print("Cannot make an admin account! <a href='../add-user.jsp'>try again</a>");
			e.printStackTrace();
		}catch(SQLSyntaxErrorException e){
			out.println("Enter all information. <a href='../add-user.jsp'>try again</a>");
		    e.printStackTrace();		
