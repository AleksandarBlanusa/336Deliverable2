...
<%
	...
	try{
        ...
        String query = "select * from reservations join users on reservations.user_id = users.user_id where flight_id = ?";
	    ...
	    boolean hasResults = false;
			...
			while(rs.next()){
				...
				String first = rs.getString("users.firstname");
				String last = rs.getString("users.lastname");
		...
		if (!hasResults) {
		    out.println("No reservations found for flight_id = " + flightid);
		}
